...
exports.getDefault = function(req, res, next){
    ...
    var linkCursor = Link.collection.find({"uid":uid,"results.content-type":{ $regex: /javascript/i }});
    ...
    res.render(req.render, {user: req.user, form: form, error: error, plans: plans, requests: requests, links:links});
