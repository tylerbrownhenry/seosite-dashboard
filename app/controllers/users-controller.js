...
var deleteAllUserData = require('./delete-controller').deleteAllUserData,
     deleteEverything = require('./delete-controller').deleteEverything,
     deleteAll = require('./delete-controller').deleteAll,
     getAll = require('./delete-controller').getAll,
     deleteAccount = require('./delete-controller').deleteAccount,
     _deleteAccount = require('./delete-controller')._deleteAccount;
