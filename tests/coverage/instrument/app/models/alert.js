...
__cov_6IMCvZ$34C0NSPfaFmLpzQ.s['1']++;var dynamoose=require('dynamoose');__cov_6IMCvZ$34C0NSPfaFmLpzQ.s['2']++;var alertSchema=new dynamoose.Schema({alertId:{type:String,hashKey:true},uid:{type:String},messages:{type:Array,default:[]},source:{type:String},type:{type:String},status:{type:String},requestDate:{type:String,default:+new Date()},temp_id:{type:String,default:null},requestId:{type:String,default:null},i_id:{type:String,default:null}});__cov_6IMCvZ$34C0NSPfaFmLpzQ.s['3']++;module.exports=dynamoose.model('Alert',alertSchema,{create:true});
